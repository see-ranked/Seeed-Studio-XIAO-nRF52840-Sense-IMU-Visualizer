...
[![GitHub Pages](https://img.shields.io/badge/Demo-GitHub%20Pages-blue?logo=github)](https://see-ranked.github.io/Seeed-Studio-XIAO-nRF52840-Sense-IMU-Visualizer/visualizer/)
[![Repository](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/see-ranked/Seeed-Studio-XIAO-nRF52840-Sense-IMU-Visualizer)
...
**インストール不要でブラウザから直接お試しいただけます：**

👉 **[https://see-ranked.github.io/Seeed-Studio-XIAO-nRF52840-Sense-IMU-Visualizer/visualizer/](https://see-ranked.github.io/Seeed-Studio-XIAO-nRF52840-Sense-IMU-Visualizer/visualizer/)**

| 接続方法 | 対応ブラウザ | 説明 |
|----------|------------|------|
| 📡 Serial (USB) | Chrome / Edge | USB接続したXIAOからシリアルデータを受信 |
| 📶 Bluetooth | Chrome / Edge | BLE経由でワイヤレスにデータを受信 |

> [!NOTE]
> GitHub PagesはHTTPS配信のため、Web Serial APIおよびWeb Bluetooth APIが追加設定なしで動作します。
...
`visualizer/index.html` をChromeまたはEdgeに直接ドラッグ＆ドロップ

> [!WARNING]
> `file://` から開いた場合、Web Serial APIおよびWeb Bluetooth APIが動作しない場合があります。
> シリアル接続・BLE接続いずれも使用する場合は方法1〜3を使用してください。
